export const frequentlyAskedQuestions = {
  ...
  data: {
    questions: [
      {
        question: 'O que é o Estartando Devs?',
        answer:
          'O Estartando Devs é um projeto social que tem como objetivo transformar vidas através da educação e da tecnologia. Acreditamos que todo mundo merece ter acesso a oportunidades reais na área tech, e é por isso que oferecemos formações gratuitas para quem quer começar ou mudar de carreira.',
      },
      {
      ...
      },
      {
        ...
        answer:
          'Simples e direto:\n\n• Preenchimento de formulário\n• Bate-papo com o nosso time',
      },
      {
        question: 'O curso é online?',
        answer:
          'Sim, 100% online. Você só precisa de um computador ou notebook e conexão com a internet.',
      },
      {
        question: 'Já trabalho com tecnologia. Posso me inscrever?',
        answer:
          'Não. O Estartando Devs é voltado para quem ainda não atua na área, e quer iniciar sua jornada profissional com apoio e formação de qualidade.',
      },
      {
        question: 'Recebo certificado ao final do curso?',
        answer:
          'Sim! Você recebe um certificado de conclusão ao finalizar o curso.',
      },
    ],
  },
};
